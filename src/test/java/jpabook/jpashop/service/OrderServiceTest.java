...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        //then
        Optional<Orders> getOrder = orderRepository.findById(orderId);
        Orders orders = getOrder.get();

        assertEquals("상품 주문시 상태는 ORDER", OrderStatus.ORDER, orders.getStatus());
        assertEquals("주문한 상품 종류 수가 정확해야 한다", 1, orders.getOrderItems().size());
